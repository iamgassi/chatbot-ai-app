...
-- Create the trigger function to set create_at
...
(3, `If the customer seems like they are going to buy after some time in the
conversation, then provide them with the coupon code PODCAST10 for 10 percent off of
platinum or diamond. Don't do this straight away but only if you think they'll purchase.
`),
(3, 'Platinum is £597.'),
...
(2, 'Of course! We offer a variety of products. Which one are you interested in?'
'ai'),
(3, 'What does the Zero to Full Stack Hero course include?', 'user'),
(3, 'The course includes 250 hours of coaching calls, access to a GitHub repo, and more.
','ai'),
...
(4, 'If you use the coupon code PODCAST10, you can get 10% off the Platinum or Diamond
packages.', 'ai'),
